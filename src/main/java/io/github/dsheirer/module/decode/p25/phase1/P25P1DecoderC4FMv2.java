        ...
        ISourceEventListener, ISourceEventProvider, Listener<ComplexSamples>
{
    ...
    {
        return "P25 Phase 1 C4FM v2";
    }

    /**
     * Configures the Gardner TED loop bandwidth.
     * @param bandwidth normalized loop bandwidth (0.001-0.1)
     */
    public void setGardnerBandwidth(float bandwidth)
    {
        mSymbolProcessor.setGardnerBandwidth(bandwidth);
    }

    /**
     * Configures the AFC tracking alpha.
     * @param alpha tracking speed (0.001-0.1)
     */
    public void setAfcAlpha(float alpha)
    {
        mSymbolProcessor.setAfcAlpha(alpha);
    }

    /**
     * Configures whether adaptive decision thresholds are enabled.
     */
